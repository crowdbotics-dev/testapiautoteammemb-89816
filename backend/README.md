...
## Project Structure
    ...
    ├── testapiautoteammemb_89816  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_89816`
...
2. Clone this repo and `cd testapiautoteammemb_89816`
